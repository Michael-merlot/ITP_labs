...
// Мы создаём объект Pattern, компилируя регулярное выражение. Это регулярное выражение будет
// использоваться для поиска всех чисел (целых и с плавающей точкой) в тексте.
        // Создаём объект Matcher, который будет использоваться для поиска совпадений в заданной строке text.
